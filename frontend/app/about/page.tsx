...
export default function AboutPage() {
  ...
  return (
    <main className="w-screen min-h-screen bg-[#020b14] overflow-y-auto">
      ...
      {/* Top HUD bar */}
      <div className="sticky top-0 z-10 flex items-center justify-between px-4 md:px-6 py-3 hud-border border-t-0 border-l-0 border-r-0 bg-[#020b14]">
        {/* Logo */}
        ...
        <span className="text-[var(--hud-primary)] text-xs tracking-widest opacity-60 hidden md:block">
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-8 py-10 md:py-16">
        ...
        {/* Hero */}
        <div className="mb-10 md:mb-16 hud-corner" style={{ padding: '2px' }}>
          <div className="border border-[var(--hud-border)] p-6 md:p-8" style={{ boxShadow: '0 0 40px rgba(0,212,255,0.05)' }}>
            <p className="text-xs tracking-[0.4em] opacity-50 mb-3 text-[var(--hud-primary)]">
              MISSION BRIEFING
            </p>
            <h1 className="text-2xl md:text-3xl tracking-widest text-[var(--hud-primary)] mb-4 font-bold">
        ...
        <div className="mb-10 md:mb-12">
          ...
          <div className="space-y-3 md:space-y-4">
            {[
              ...
              <div
                key={item.step}
                className="flex gap-4 md:gap-6 p-4 md:p-6 border border-[var(--hud-border)]"
        ...
        <div className="mb-10 md:mb-12">
          ...
          <div className="border border-[var(--hud-border)] p-4 md:p-6" style={{ background: 'rgba(0,212,255,0.02)' }}>
        ...
        <div className="text-center pb-8">
          <button
            onClick={() => router.push('/')}
            className="px-8 md:px-12 py-4 text-sm tracking-[0.4em] transition-all"
            style={{
